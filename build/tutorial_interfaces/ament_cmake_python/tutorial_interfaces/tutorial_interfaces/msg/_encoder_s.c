...
bool tutorial_interfaces__msg__encoder__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._encoder.Encoder", full_classname_dest, 40) == 0);
  }
  tutorial_interfaces__msg__Encoder * ros_message = _ros_message;
  {  // first
...
PyObject * tutorial_interfaces__msg__encoder__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._encoder");
