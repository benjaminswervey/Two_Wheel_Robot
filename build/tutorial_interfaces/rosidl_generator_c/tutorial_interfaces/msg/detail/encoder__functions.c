...
tutorial_interfaces__msg__Encoder__create()
{
  ...
  tutorial_interfaces__msg__Encoder * msg = (tutorial_interfaces__msg__Encoder *)allocator.allocate(sizeof(tutorial_interfaces__msg__Encoder), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tutorial_interfaces__msg__Encoder__Sequence__init(tutorial_interfaces__msg__Encoder__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tutorial_interfaces__msg__Encoder *)allocator.zero_allocate(size, sizeof(tutorial_interfaces__msg__Encoder), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__msg__Encoder__Sequence * array = (tutorial_interfaces__msg__Encoder__Sequence *)allocator.allocate(sizeof(tutorial_interfaces__msg__Encoder__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
tutorial_interfaces__msg__Encoder__Sequence__are_equal(const tutorial_interfaces__msg__Encoder__Sequence * lhs, const tutorial_interfaces__msg__Encoder__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutorial_interfaces__msg__Encoder__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutorial_interfaces__msg__Encoder__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutorial_interfaces__msg__Encoder);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutorial_interfaces__msg__Encoder * data =
      (tutorial_interfaces__msg__Encoder *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces__msg__Encoder__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutorial_interfaces__msg__Encoder__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutorial_interfaces__msg__Encoder__copy(
