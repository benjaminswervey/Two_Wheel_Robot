...
#ifndef TUTORIAL_INTERFACES__MSG__DETAIL__ENCODER__STRUCT_H_
#define TUTORIAL_INTERFACES__MSG__DETAIL__ENCODER__STRUCT_H_
...
#endif  // TUTORIAL_INTERFACES__MSG__DETAIL__ENCODER__STRUCT_H_
