...
{
  new (message_memory) tutorial_interfaces::msg::Encoder(_init);
}

void Encoder_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces::msg::Encoder *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Encoder_message_member_array[2] = {
  {
    ...
    offsetof(tutorial_interfaces::msg::Encoder, first),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::msg::Encoder, second),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Encoder_message_members = {
  ...
  2,  // number of fields
  sizeof(tutorial_interfaces::msg::Encoder),
...
{
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::Encoder_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, msg, Encoder)() {
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::Encoder_message_type_support_handle;
}
